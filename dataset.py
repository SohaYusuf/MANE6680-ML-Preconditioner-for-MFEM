...
#         #print('\n key in add_targets: ',key)
#         out[key] = val[0] 
#         out['target|'+key] = val[1]
        
#     out['cells'] = tf.reshape(out['cells'],[1,32,3])
#     out['node_type'] = tf.reshape(out['node_type'],[1,25,1])
#     out['mesh_pos'] = tf.reshape(out['mesh_pos'],[1,25,2])
#     out['temperature'] = tf.reshape(out['temperature'],[1,25,1])
#     out['target|temperature'] = tf.reshape(out['target|temperature'],[1,25,1])
